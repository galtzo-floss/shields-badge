...
RSpec.describe Shields::Badge::Downloads::GemTotalDownloads do
...
RSpec.describe Shields::Badge::Downloads::GemTotalDownloads::PathDto do
  let(:instance) { described_class.new(**args) }
  let(:args) { {gem: "orange"} }
...
RSpec.describe Shields::Badge::Downloads::GemTotalDownloads::QueryDto do
  let(:instance) { described_class.new(**args) }
