...
- One spec file per class/module. For each class or module under `lib/`, keep all of its unit tests in a single spec file under `spec/` that mirrors the path and file name exactly: `lib/shields/badge/my_class.rb` -> `spec/shields/badge/my_class_spec.rb`.
...
[🧪build]: https://github.com/galtzo-floss/shields-badge/actions
